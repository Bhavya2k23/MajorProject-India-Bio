...
const Animals = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE}/animals?limit=2000`)
      .then((res) => {
    ...
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10 space-y-4 animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">Explore India's Wildlife</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Discover India's diverse fauna — fully optimized data index.
          </p>
        </div>
          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="text-sm text-muted-foreground">
              {loading ? (
                ...
                <span>Showing <strong>{filteredSpecies.length}</strong> unique species</span>
              )}
            </div>
          </div>
        </div>
              ...
              {paginatedSpecies.map((species) => {
                ...
                return (
                  <div 
                    ...
                    onClick={() => navigate(`/animals/${species.id}`)}
                  >
